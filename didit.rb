...
API_VERSION = '0.1'
API_TOKEN = ENV['I_DONE_IT_API_TOKEN']
...
def config_works()
  ...
  return (team != nil and team['result']['done_count'] != nil)
end
...
def discover_urls()
  ...
  $endpoints[:TEAMS_ENDPOINT] = endpoints[0]
  $endpoints[:DONES_ENDPOINT] = endpoints[1]
